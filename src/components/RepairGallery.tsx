...
export default function RepairGallery({ items = [] }: { items?: CaseItem[] }) {
  // Eğer panelden eklenmiş veri varsa onları göster, yoksa varsayılanları göster
    ...
    <section className="py-16 px-4 max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {displayItems.map((item, idx) => {
          // Sanity görseli mi yoksa yerel dosya yolu mu kontrolü
