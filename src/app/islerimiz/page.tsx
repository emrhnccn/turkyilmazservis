...
export default async function WorksPage() {
  ...
  return (
    <main className="relative min-h-screen bg-zinc-950 text-slate-100 py-12 px-4 sm:px-6 lg:px-10 selection:bg-red-600 selection:text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="flex items-center justify-between mb-10 pb-5 border-b border-zinc-800">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm font-semibold text-zinc-300 hover:text-red-500 transition-colors"
          >
            <ArrowLeft className="w-4 h-4" /> Ana Sayfaya Dön
          </Link>
          <a
            href="tel:05521164128"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 text-white text-xs sm:text-sm font-extrabold px-4 py-2.5 rounded-xl shadow-lg shadow-red-600/20 transition-all hover:scale-105 active:scale-95"
          >
